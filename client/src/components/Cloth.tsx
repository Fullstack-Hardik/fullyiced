        ...
        <div className="p-[clamp(34px,6vh,80px)_clamp(20px,4vw,64px)] self-center">
          ...
          <dl className="mt-[26px] border-t border-[rgba(16,16,16,0.18)]">
            <div className="flex justify-between gap-[14px] py-[11px] border-b border-[rgba(16,16,16,0.1)] text-[12.5px]">
              <dt className="font-semibold">Melton wool</dt>
              <dd className="text-[#5A574F]">620 gsm · Huddersfield</dd>
            </div>
            <div className="flex justify-between gap-[14px] py-[11px] border-b border-[rgba(16,16,16,0.1)] text-[12.5px]">
              <dt className="font-semibold">Dry cotton</dt>
              <dd className="text-[#5A574F]">340 gsm · Osaka</dd>
            </div>
            <div className="flex justify-between gap-[14px] py-[11px] border-b border-[rgba(16,16,16,0.1)] text-[12.5px]">
              <dt className="font-semibold">Lambswool</dt>
              <dd className="text-[#5A574F]">7 gauge · Hawick</dd>
            </div>
          </dl>
        </div>
