...
const getFontValue = (value: any) => (typeof value === 'number' ? `${value}px` : value);

const measureLine = (ctx: any, line: any, letterSpacing: any) => {
...
const drawLine = (ctx: any, line: any, x: any, y: any, letterSpacing: any) => {
  const chars = Array.from(line);
...
const WarpText = ({
  ...
  useEffect(() => {
    ...
    const onReducedMotion = (event: any) => {
